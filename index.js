window.addEventListener('load', async() => {
    ...
    const response = await fetch('https://api.freecurrencyapi.com/v1/currencies?apikey=fca_live_oP3o9coOxPrLTWSgr7MdOOwuWQmN0ZvCWt0gJ4LX&currencies=&base_currency=INR')
    ...
    form.onsubmit = async function(e) {
        ...
        const convert = await fetch(`https://api.freecurrencyapi.com/v1/latest?apikey=fca_live_oP3o9coOxPrLTWSgr7MdOOwuWQmN0ZvCWt0gJ4LX&currencies=${toData}&base_currency=${fromdata}`);
